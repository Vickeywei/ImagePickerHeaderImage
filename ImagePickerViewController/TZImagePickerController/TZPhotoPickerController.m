...
- (void)takePhoto {
    ...
    if ((authStatus == AVAuthorizationStatusRestricted || authStatus ==AVAuthorizationStatusDenied) && iOS8Later) {
        [WQAlert showAlertViewControllerWithTitle:@"无法使用相机" message:@"请在iPhone的""设置-隐私-相机""中允许访问相机" buttonTitles:@[@"取消",@"设置"] showViewController:self completionBlock:^(int index) {
            switch (index) {
                case 1: {
